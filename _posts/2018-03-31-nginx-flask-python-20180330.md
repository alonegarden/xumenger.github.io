...
tags: Mac Linux WSGI nginx uWSGI flask python web http 服务器 Werkzeug CDN 负载均衡 配置文件 Web服务器 反向代理服务器 反向代理 HTTP缓存 转发 sock文件
---
...
![image](../media/image/2018-03-30/05.png)
...
![image](../media/image/2018-03-30/06.png)

然后可以在webapp的目录上生成了.log和.sock文件

![image](../media/image/2018-03-30/07.png)
...
![image](../media/image/2018-03-30/08.png)
