...
>相比于前面的那些复杂的构建语句，简单介绍一下这个语句的含义：创建一个名为joker 的Person 节点，创建一个名为funny 的Movie 节点，然后它们之间的关系是ACTED\_IN...

同样的我们可以用模式匹配去查询

![](../media/image/2018-08-20/11.png)

>相比于前面的那些查询语句，简单介绍一下这个语句的含义：查找符合这样条件的信息，Person 实体的名字为joker，它和一个Movie 实体之间存在ACTED\_IN 的关系...
