...
// 进行装箱，转换成object类型，因为上一步返回的是值类型，所以在这一步进行装箱，过程：弹出上一步返回的值，进行装箱，并将对象的引用推送到计算堆栈上，此时深度为【1】    
...
// 如果为 true、非空或非零，则跳转到IL_0057的位置，此时深度为【0】
...
>来自[IL指令详细](https://www.cnblogs.com/zery/p/3368460.html)，方便自己快速查阅
