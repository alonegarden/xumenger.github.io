navicat Oracle MySQL AWR 执行计划 SQLPlus awrrpt 执行计划 快照 OCI SQL SharedPool
...
>AWR 反应的是点对点的数据。比如说，生成一个今天9:00到12:00的AWR 报告，那么，看到的，就是12:00和9:00两个时间点的变化。但9:00-10:00、10:00-11:00、11:-12:00 分别是什么样的，看不到
