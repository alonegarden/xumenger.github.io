...
可以看到其有实现SmartInstantiationAwareBeanPostProcessor、BeanFactoryAware，关于BeanPostProcessor、BeanFactoryAware 的原理，在前两篇文章刚好有讲到

* SmartInstantiationAwareBeanPostProcessor 在Bean 初始化前后做相关事情
* BeanFactoryAware 实现BeanFactory 的自动装配！
