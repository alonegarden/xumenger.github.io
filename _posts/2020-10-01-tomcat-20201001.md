...
Linux 操作系统层面对外将TCP 协议封装为socket 接口！具体也在Linux 源码的net/ 目录下！
...
在比如Java 中Thread 类中有isAlive、suspend0、resume0 等native 方法，对应可以在openjdk/jdk/src/share/native/java/lang/Thread.c 找到其实现
