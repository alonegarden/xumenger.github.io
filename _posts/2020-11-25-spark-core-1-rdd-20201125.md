...
>关于Spark RDD 的更多API 可以参考[http://spark.apache.org/docs/latest/api/scala/org/apache/spark/rdd/index.html](http://spark.apache.org/docs/latest/api/scala/org/apache/spark/rdd/index.html)
