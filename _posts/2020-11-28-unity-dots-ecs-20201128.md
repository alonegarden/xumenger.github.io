...
tags: Unity UD ECS 性能 内存 DOD 面向数据编程 DOTS C# 委托 HybridECS PureECS Burst SIMD CPU 
---
...
设置100 x 100 个游戏实体，最终运行的效果如下，可以看到FPS 大概是9FPS
...
打开Window -> Analysis -> Profiler 看一下，现在这种情况下是只有一个线程的来处理的
